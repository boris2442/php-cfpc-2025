...
<section class="min-h-screen flex flex-col md:flex-row items-center justify-center px-6 py-12 bg-green-50">
    ...
    <div class="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
      ...
      <a href="#"
         class="inline-block bg-green-600 text-white px-6 py-3 rounded-full text-lg hover:bg-green-700 transition">
        Découvrir
      </a>
    </div>
    ...
    <div class="md:w-1/2 flex justify-center">
      <!-- <img src="https://source.unsplash.com/600x400/?nature,green" alt="Image accueil"
